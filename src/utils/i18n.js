...
const resources = {
  es: {
    translation: {
      ...
      // ── Finalists ──────────────────────────────────────────
      finalists: {
        noFinalists: "Sin finalistas aún",
        noFinalistsDesc: "Los finalistas aparecerán aquí una vez que la votación cierre y se calcule",
      ...
      voting: {
        active: "Activo",
        inactive: "Inactivo",
        disableQr: "Deshabilitar QR",
        approveFirst: "Aprueba a los finalistas primero",
        selectExpFirst: "Selecciona una fecha de expiración",
        generateQr: "Generar QR",
        generating: "Generando...",
        disableLink: "Deshabilitar Enlace",
        staffVotingLink: "Enlace de Votación del Staff",
        private: "PRIVADO",
        staffVotingDesc: "Genera un enlace privado solo para staff. Este enlace es diferente del QR público y no será visible para la audiencia.",
        copy: "Copiar",
        copied: "¡Copiado!",
        regenLink: "Regenerar Enlace",
        genStaffLink: "Generar Enlace Staff",
        approveBeforeGen: "Aprueba finalistas antes de generar el enlace staff",
        disabling: "Deshabilitando...",
        eventRanking: "Ranking del Evento",
        topTeams: "Equipos destacados",
        approveFinalistsBtn: "Aprobar Finalistas",
        finalistsApprovedBtn: "Finalistas Aprobados",
        submitVotesAndCalc: "Enviar Votos & Calcular Ganadores",
        calcWinners: "Calculando ganadores...",
        winnersCalculated: "¡Ganadores calculados!",
        votingClosed: "¡Votación cerrada con éxito!",
        winnersCalculatedGo: "Se han calculado los ganadores. Ve a la página de Finalistas para ver el podio."
      },

      publicVoting: {
        voteError: "Error al enviar el voto.",
        noTeams: "No hay equipos disponibles aún.",
        voteRegistered: "¡Voto registrado!",
        thanks: "Gracias por participar. Serás redirigido en unos segundos.",
        submitting: "Enviando...",
        submitRanking: "Enviar mi ranking",
        title: "Votación TeamUp",
        subtitle: "Arrastra los equipos al podio · tu 1er lugar es tu voto",
        dragToPodium: "Arrastra un equipo al podio",
        allPlaced: "Todos los equipos colocados en el podio",
        alreadyVoted: "✓ Ya votaste",
        fillSpots: "Llena los 3 lugares del podio para votar",
        eventNotFound: "Evento no encontrado",
        eventNotExist: "Este evento no existe o ya no está disponible."
      },
  ...
  en: {
    translation: {
      ...
      finalists: {
        ...
        noFinalistsDesc: "Finalists will appear here once the voting is closed and calculated",
      ...
      voting: {
        ...
        approveFirst: "Approve finalists first",
        selectExpFirst: "Select an expiration date first",
        generateQr: "Generate QR",
        generating: "Generating...",
        disableLink: "Disable Link",
        staffVotingLink: "Staff Voting Link",
        private: "PRIVATE",
        staffVotingDesc: "Generate a private link for staff members only. This link is different from the public QR and won't be visible to the audience.",
        copy: "Copy",
        copied: "Copied!",
        regenLink: "Regenerate Link",
        genStaffLink: "Generate Staff Link",
        approveBeforeGen: "Approve finalists before generating the staff link",
        disabling: "Disabling...",
        eventRanking: "Event Ranking",
        topTeams: "Top performing teams",
        approveFinalistsBtn: "Approve Finalists",
        finalistsApprovedBtn: "Finalists Approved",
        submitVotesAndCalc: "Submit Votes & Calculate Winners",
        calcWinners: "Calculating winners...",
        winnersCalculated: "Winners calculated!",
        votingClosed: "Voting closed successfully!",
        winnersCalculatedGo: "Winners have been calculated. Go to the Finalists page to see the podium."
      },
      ...
      publicVoting: {
        ...
        thanks: "Thanks for participating. You will be redirected in a few seconds.",
        submitting: "Submitting...",
        submitRanking: "Submit my ranking",
        title: "TeamUp Voting",
        subtitle: "Drag teams to the podium · your 1st place is your vote",
        dragToPodium: "Drag a team to the podium",
        allPlaced: "All teams placed on the podium",
        alreadyVoted: "✓ Already voted",
        fillSpots: "Fill all 3 podium spots to vote",
        eventNotFound: "Event not found",
        eventNotExist: "This event doesn't exist or is no longer available."
      },
