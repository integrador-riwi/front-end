...
import { createQR } from "../services/api.js";
...
export default class QRVoting {
  ...
  async generateQR() {
    try{
      ...
      qrSection.src = createQR(getSelectedEvent(), "2026-03-27T24:00:00.000Z")
    }
     catch (err) {
      console.error("Failed QR generation:", err);
      this.error =
        err.message || "Error while generating QR. Please try again later.";
    }
  }
