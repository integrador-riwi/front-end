...
export default class EventsView {
    ...
    renderEventsList() {
      ...
      `;
        ...
        const now = new Date();
        const pastEvents = this.events.filter(e => new Date(e.date || e.start_date || e.createdAt) < now);
        const inProgressEvents = this.events.filter(e => new Date(e.date || e.start_date || e.createdAt) >= now);
